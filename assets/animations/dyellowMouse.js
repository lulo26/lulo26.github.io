(function (cjs, an) {
	...
	if (reversed == null) { reversed = false; }
		...
		this.T_head.setTransform(7.75,-6.7,1,1,0.2815,0,0,203.1,110.3);
	
		this.T_body = new lib.T_body();
		this.T_body.name = "T_body";
		this.T_body.setTransform(9.9,-23.9,1,1,-3.9822,0,0,91.8,7.6);
	
		this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.T_body},{t:this.T_head}]}).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-87.3,-117.4,174.6,234.9), null);
	...
	if (reversed == null) { reversed = false; }
		...
		this.T_head = new lib.T_head2();
		this.T_head.name = "T_head";
		this.T_head.setTransform(217.4,209.5,1,1,5.7732,0,0,203.2,110.4);
