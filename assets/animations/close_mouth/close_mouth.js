...
// stage content:
(lib.close_mouth = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(186.6,171.25,1,1,0,0,0,72,82.7);
	...
	this.T_head.setTransform(217.35,209.5,0.9273,0.9999,9.479,0,0,203.2,110.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.T_body},{t:this.instance,p:{regX:72,scaleX:1,x:186.6}}]}).to({state:[{t:this.T_body},{t:this.instance,p:{regX:72.1,scaleX:0.9514,x:186.75}}]},1).to({state:[{t:this.T_body},{t:this.T_head,p:{regY:110.5,scaleX:0.9273,y:209.5,scaleY:0.9999,rotation:9.479,x:217.35,regX:203.2}}]},2).to({state:[{t:this.T_body},{t:this.T_head,p:{regY:110.4,scaleX:0.9999,y:209.45,scaleY:0.9999,rotation:9.479,x:217.35,regX:203.2}}]},1).to({state:[{t:this.T_body},{t:this.T_head,p:{regY:110.4,scaleX:1,y:209.5,scaleY:1,rotation:5.7732,x:217.4,regX:203.2}}]},1).to({state:[{t:this.T_body},{t:this.T_head,p:{regY:110.3,scaleX:1,y:209.35,scaleY:1,rotation:0.2815,x:217.35,regX:203.1}}]},1).wait(1));
...
// library properties:
lib.properties = {
	id: '0AC87D94BD805044ABFA8D9E12A498E2',
	width: 400,
	height: 400,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['0AC87D94BD805044ABFA8D9E12A498E2'] = {
